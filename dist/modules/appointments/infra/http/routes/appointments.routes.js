...
var _checkAuthenticated = _interopRequireDefault(require("../../../../users/infra/http/middlewares/checkAuthenticated"));
...
appointmentsRouter.use(_checkAuthenticated.default);
